import 'package:apps/Screens/ForgotPassword.dart';
import 'package:apps/Screens/Homepage.dart';
import 'package:apps/Screens/Signup.dart';
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          child: Text("Don't have an Account",style: GoogleFonts.merriweather(color: Colors.white,fontSize: 15),),
          ),
          ElevatedButton(onPressed: (){
            Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => Signup()));
          }, child: Text('SignUp',style: GoogleFonts.merriweather(color: Colors.white,fontSize: 15),),
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    Column(
                      children: [
                        Text("Welcome Back",style: GoogleFonts.lemon(fontSize: 30,color: Color(0xff1f3751),)),
                        SizedBox(height: 20,),
                        Text('Enter Your Details',style: GoogleFonts.merriweather(fontSize: 14,color: Color(0xff1f3751)),),
                        Center(
                          child: Form(
                            key: _formkey,
                            child: Column(
                              ...
                              children: [
                                ...
                                Center(
                                  ...
                                  ), child: Text('Forgot Password',style: GoogleFonts.merriweather(color: Colors.grey,fontSize: 15),)),
                                ),
                                SizedBox(height: 10,),
                                Center(child: Text('Or Sign In With',style: GoogleFonts.merriweather(color: Colors.grey,fontSize: 15),)),
                                SizedBox(height: 40,),
                                Center(
                                  child: Padding(
